  ...
  return (
    <div className="Safety">
      ...
      <div className="safeN">
        <h1>성인 자전거 안전 강의</h1>
        <div className="yout">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/ZfG-CIrbkzE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <h1>안전한 자전거 타기 강의</h1>
        <div className="yout">
