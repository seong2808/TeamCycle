export default function bikesafe() {
    return (
      <div className="bikesafe">  
        <div id="fs_container_wrap">

          <section class="fs_sub_visual" >
            <div class="snb_vis_box">
              <div class="stc animated fadeInUp"><h3>자전거 안전 이용수칙</h3></div>
              <p class="sta animated fadeInDown">자전거 행복나눔과 함께하는 행복 안전 라이딩</p>
            </div>
          </section>
                          ...
                          <div id="contentHtml" >
                            <div class="sub030201">
                              ...
                              <div class="text_photo">
                                ...
                                <img src="./safety_driver.jpg" alt="자전거 이미지"/>
                              </div>
                              ...
                              <div class="text_photo mt40">
                                ...
                                <img src="./safety_driver02.jpg" alt="자전거 이미지"/>
                              </div>
                              ...
                              <div class="transmission img">
                                <img src='./transmission.png' width="1030px" height="300px" />									
                              </div>
